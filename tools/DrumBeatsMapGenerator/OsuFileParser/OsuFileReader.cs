...
namespace OsuFileParser {
    public class OsuFileReader {
        ...
        /// Returned from Parse()
        /// </summary>
        private static readonly OsuBeatmap Beatmap = new OsuBeatmap();
        ...
        public static OsuBeatmap Read(string path) {
            Match  keyvalue;
            ...
            foreach(var line in File.ReadAllLines(path)) {
                ...
                if(!validFile) {
                    ...
                    // Modified Exception for version prop...
                    ...
                    if(versionMatch.Success) {
                        ...
                        if(version < 4) {
                            throw new Exception($"The osu version of the file is too old. Version: {version}");
                        }

                        continue;
                    }

                    else { throw new Exception($"The line: {line} isn't well formatted"); }
                }
                ...
                if(uselessSections.Contains(currentSection))
                    continue;

                else if(genericProperties.Contains(currentSection)) { SetValueToBeatmapProperty(currentSection, line); }
                    ...
                    else { SetValueToBeatmapProperty(key, value); }
                }
            }
        ...
        private static void SetValueToBeatmapProperty(string propertyName, object value) {
            ...
            PropertyInfo property = typeof(OsuBeatmap).GetProperty(propertyName);
